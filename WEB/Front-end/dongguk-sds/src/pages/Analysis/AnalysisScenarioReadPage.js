...
function AnalysisScenarioReadPage({ match }) {
    ...
    return (
        ...
        <div className="flex flex-col px-16 py-12 space-y-2 bg-white rounded-md items-center border border-gray-300">
            <div className="bg-gray-200 w-full text-center">Scenario Content</div>
                ...
                <button type="button" onClick={edit} className="px-4 py-3 text-sm text-white font-semibold bg-blue-500 rounded-md hover:bg-blue-600 ">EDIT</button>
...
export default AnalysisScenarioReadPage;